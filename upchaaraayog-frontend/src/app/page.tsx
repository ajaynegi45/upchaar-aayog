        ...
        <>
            ...
            <section className="px-6 py-24 max-w-7xl mx-auto" aria-labelledby="features-heading">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <article
                        className="bg-surface-container-lowest p-8 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-lg transition-shadow border-b-4 border-primary/10 flex flex-col items-center text-center">
                        <div
                            className="w-16 h-16 bg-primary-container rounded-full flex items-center justify-center mb-6">
              <span className="material-symbols-outlined text-on-primary-container text-3xl" aria-hidden="true">
                medication
                    ...
                    <article
                        className="bg-surface-container-lowest p-8 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-lg transition-shadow border-b-4 border-secondary/10 flex flex-col items-center text-center">
                        <div
                            className="w-16 h-16 bg-secondary-container rounded-full flex items-center justify-center mb-6">
              <span className="material-symbols-outlined text-on-secondary-container text-3xl" aria-hidden="true">
                volunteer_activism
                    ...
                    <article
                        className="bg-surface-container-lowest p-8 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-lg transition-shadow border-b-4 border-primary/10 flex flex-col items-center text-center">
                        <div
                            className="w-16 h-16 bg-tertiary-fixed-dim rounded-full flex items-center justify-center mb-6">
            ...
            <span
                className="inline-block px-4 py-1 rounded-full bg-secondary-container text-on-secondary-container text-xs font-bold uppercase tracking-wider mb-6">
              Ayushman Bharat
            </span>
                ...
                <div className="flex flex-col md:flex-row-reverse items-center gap-16">
                    <div className="w-full md:w-1/2">
            <span
                className="inline-block px-4 py-1 rounded-full bg-primary-container text-on-primary-container text-xs font-bold uppercase tracking-wider mb-6">
              Jan Aushadhi
            </span>
                        <h2 className="font-headline text-3xl md:text-4xl font-extrabold text-on-surface mb-6">
            ...
            <section className="bg-surface-container py-20 px-6">
                <div
                    className="max-w-4xl mx-auto bg-surface-container-lowest rounded-2xl p-8 md:p-12 shadow-[0_32px_48px_rgba(45,52,51,0.04)] text-center">
            ...
            <section className="py-24 px-6 text-center">
                <div className="max-w-3xl mx-auto">
                    ...
                    <button
                        className="bg-primary hover:bg-primary-dim text-on-primary text-xl px-12 py-5 rounded-xl font-bold transition-all shadow-xl hover:shadow-2xl active:scale-95 focus:ring-4 focus:ring-primary/20">
                        Find Nearby Centres
                    </button>

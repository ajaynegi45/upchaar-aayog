...
//     return (
//         <div
//             className="bg-surface-container-low p-5 md:p-8 rounded-[2.5rem] md:rounded-[3rem] border border-outline-variant/20 shadow-2xl shadow-primary/5 transition-all">
//             <div className="flex flex-col gap-6 md:gap-8">
//
//                 {/* State Selection - Compulsory */}
//                 <div className="space-y-3">
//                     <label
//                         className="text-[11px] font-black text-primary uppercase tracking-[0.25em] ml-2 flex items-center gap-2">
...
//                         </select>
//                         <span
//                             className="material-symbols-outlined absolute right-5 top-1/2 -translate-y-1/2 text-primary/40 pointer-events-none group-focus-within:text-primary transition-colors">
//               map
//             </span>
//                     </div>
//                 </div>
...
//                     <div className="space-y-3">
//                         <label
//                             className="text-[11px] font-black text-on-surface-variant/50 uppercase tracking-[0.2em] ml-2">2.
//                             District</label>
//                         <div className="relative group">
//                             <select
...
//                             </select>
//                             <span
//                                 className="material-symbols-outlined absolute right-5 top-1/2 -translate-y-1/2 text-on-surface-variant/40 pointer-events-none">
//                 location_city
//               </span>
//                         </div>
//                     </div>
...
//                     <div className="space-y-3">
//                         <label
//                             className="text-[11px] font-black text-on-surface-variant/50 uppercase tracking-[0.2em] ml-2">3.
//                             Hospital Type</label>
//                         <div className="relative group">
//                             <select
...
//                         <label
//                             className="text-[11px] font-black text-on-surface-variant/50 uppercase tracking-[0.2em] ml-2 flex items-center justify-between">
//                             4. Empanelment Schemes
//                             {isMetadataLoading && <span
//                                 className="material-symbols-outlined animate-spin text-xs">progress_activity</span>}
//                         </label>
//                         <div className="relative group">
//                             <select
//                                 multiple
...
//
//                 <div
//                     className="mt-4 pt-6 md:pt-8 border-t border-outline-variant/10 flex flex-col sm:flex-row items-center justify-between gap-6">
//                     <div className="hidden md:block">
//                         {!isStateSelected ? (
//                             <p className="text-on-surface-variant/40 text-[10px] font-black uppercase tracking-widest italic tracking-[0.2em]">Waiting
//                                 for state selection...</p>
//                         ) : (
//                             <p className="text-primary/60 text-[10px] font-black uppercase tracking-widest tracking-[0.2em] animate-pulse">Ready
//                                 to search hospitals</p>
//                         )}
//                     </div>
//
//                     <button

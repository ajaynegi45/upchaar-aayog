        ...
        >
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                ...
                <div className="absolute top-[35%] left-[45%] group/pin cursor-pointer pointer-events-auto">
                    <div
                        className="relative bg-white p-1.5 rounded-t-full rounded-br-full shadow-lg border-2 border-primary rotate-[-45deg] transition-all hover:scale-110 hover:-translate-y-1">
                    ...
                    <div
                        className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 bg-on-surface text-surface text-[10px] font-bold px-2 py-1 rounded shadow-xl opacity-0 translate-y-2 group-hover/pin:opacity-100 group-hover/pin:translate-y-0 transition-all whitespace-nowrap">
                        0.8km Kendra
                    </div>
                </div>
            ...
            <div className="absolute top-6 right-6">
                ...
                >
                    <span
                        className="material-symbols-outlined text-[18px] group-hover/btn:animate-spin-slow">my_location</span>
                    Recenter
                </button>
            </div>
        </section>

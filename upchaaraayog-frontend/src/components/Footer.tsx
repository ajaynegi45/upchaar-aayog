...
export default function Footer() {
    ...
    return (
        <footer className="bg-surface-container-low border-t border-on-surface/5 py-10 md:py15">
            <div
                className="max-w-7xl mx-auto px-5 md:px-12 flex flex-col md:flex-row justify-between items-start md:items-center gap-5">
                <div className="space-y-4">
                    <div className="font-headline font-semibold text-primary text-xl">
                        Upchaar Aayog
                    </div>
                    <p className="text-slate-500 max-w-2xl leading-relaxed">
                        Making essential <span>healthcare</span> and <span>medicines</span> accessible to every
                ...
                <nav aria-label="Footer Navigation">
                    <ul className="text-sm font-body">
                        ...
                        {/*</li>*/}
                        <li>
                            <Link href="https://ajaynegi.web.app/contact/" className="text-slate-500 hover:text-primary transition-all">
                                Contact Support
                            </Link>
                        </li>
                        {/*<li>*/}

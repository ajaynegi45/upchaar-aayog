  ...
  return (
    <main className="max-w-[1300px] mx-auto px-6 pt-12 pb-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <aside className="lg:col-span-4 lg:sticky lg:top-28">
          ...
          >
            <div className="flex items-center gap-2 mb-8">
              <span className="material-symbols-outlined text-primary text-2xl" style={{ fontVariationSettings: "'FILL' 1" }} aria-hidden="true">
                bookmark
              </span>
              <h2 id="selection-title" className="font-headline font-black uppercase tracking-[0.2em] text-xs text-primary">
                Your Selection
              </h2>
            </div>
            ...
            <div className="space-y-8">
              <div className="border-b border-outline-variant/20 pb-6">
                ...
                <p className="text-on-surface-variant font-bold text-sm uppercase tracking-widest opacity-70">Branded Medicine</p>
              </div>
              
              <div className="space-y-4">
                <div className="flex justify-between items-center py-1">
                  <span className="text-on-surface-variant font-bold text-xs uppercase tracking-wider">Composition</span>
                  <span className="font-black text-on-surface">Paracetamol 500mg</span>
                </div>
                <div className="flex justify-between items-center py-1">
                  <span className="text-on-surface-variant font-bold text-xs uppercase tracking-wider">Form</span>
                ...
                <div className="flex justify-between items-center pt-6 border-t border-outline-variant/10">
                  <span className="text-on-surface-variant font-bold text-xs uppercase tracking-wider">MRP <span className="text-[10px] opacity-50">(Incl. taxes)</span></span>
        ...
        <section className="lg:col-span-8 space-y-8" aria-labelledby="alternatives-title">
          <div className="mb-10 px-2">
            <h2 id="alternatives-title" className="font-headline text-3xl font-black text-on-surface mb-2">Lower-Cost Alternatives</h2>
            <p className="text-on-surface-variant font-medium text-lg">Medicines with similar composition that may cost less</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div 
              ...
              role="note"
            >
              <span className="material-symbols-outlined text-secondary text-4xl" aria-hidden="true">info</span>
              <div>
                <h3 className="font-headline font-black text-on-secondary-container mb-2 text-xl tracking-tight">Did you know?</h3>
                <p className="text-on-secondary-container font-medium leading-relaxed opacity-90">
                  Generic medicines undergo the same rigorous quality checks by regulatory authorities as branded ones. They contain the identical active pharmaceutical ingredients (APIs).
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="mt-32 pt-16 border-t border-surface-container-high" aria-labelledby="disclaimer-title">
        <div className="bg-surface-container rounded-3xl p-10 md:p-16 flex flex-col md:flex-row gap-12 items-start shadow-sm border border-outline-variant/5">
          ...
          <div className="flex-1">
            <h2 id="disclaimer-title" className="text-2xl font-headline font-black mb-4">Safety Disclaimer</h2>
            <p className="text-on-surface-variant leading-relaxed font-medium text-lg mb-8 opacity-80">
              This information is for reference only. Results are based on composition matching and may not always be exact.
              Doctors should verify before prescribing, and patients should consult a healthcare professional before
              making any changes to their medication regimen. Upchaar Aayog does not provide medical advice or prescriptions.
            </p>
            <div className="flex flex-wrap gap-4">
              {["Information Only", "Verified Composition", "Expert Consultation Required"].map((tag) => (
                <span key={tag} className="text-[10px] font-black text-primary uppercase tracking-[0.2em] bg-surface-container-lowest px-4 py-2 rounded-lg shadow-sm">
                  {tag}
                </span>
              ))}
            </div>

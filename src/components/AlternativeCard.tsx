...
export default function AlternativeCard({
  ...
  return (
    <article className="bg-surface-container-lowest rounded-2xl p-6 shadow-[0_2px_8px_rgba(0,0,0,0.04)] border border-transparent hover:border-primary/20 hover:shadow-[0_32px_48px_rgba(45,52,51,0.06)] transition-all flex flex-col md:flex-row gap-8 items-center group">
      <div className="w-full md:w-32 h-32 flex-shrink-0 bg-surface-container rounded-xl flex items-center justify-center">
        <span className="material-symbols-outlined text-4xl text-outline-variant group-hover:scale-110 transition-transform">
          pill
        </span>
      </div>
      ...
      <div className="w-full md:w-auto flex flex-col items-center md:items-end gap-4 min-w-[140px] border-t md:border-t-0 md:border-l border-outline-variant/10 pt-4 md:pt-0 md:pl-8">
